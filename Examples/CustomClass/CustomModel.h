...
namespace CustomModel
{
    ...
    /// <summary>
    /// Provides utility methods to interact with an instance of OWL class MyCustomCylinder
    /// You also can use object of this C++ class instead of int64_t handle of the OWL instance in any place where the handle is required
    /// </summary>
    ...
    public:
       ...
       //
        ...
        bool set_MyCustomBool(const bool* values, int64_t count) { return SetDatatypeProperty ("MyCustomBool", values, count); }
        ...
        bool set_MyCustomString(const char* const* values, int64_t count) { return SetDatatypeProperty ("MyCustomString", values, count); }
    ...
    public:
       ...
       //
        ...
        bool set_tangent(const double* values, int64_t count) { return SetDatatypeProperty ("tangent", values, count); }
