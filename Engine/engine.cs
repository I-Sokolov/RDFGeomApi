...
namespace RDF
{
	...
	class engine
	{
		...
		/// 
		/// return code for SetNameOfClass/Property
		/// 
        public enum enum_error_code_set_uri
        {
            SUCCESSFUL = 0,
		...
		public static extern enum_error_code_set_uri SetNameOfClass(Int64 owlClass, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfClass")]
		public static extern enum_error_code_set_uri SetNameOfClass(Int64 owlClass, byte[] name);
		...
		public static extern enum_error_code_set_uri SetNameOfClassW(Int64 owlClass, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfClassW")]
		public static extern enum_error_code_set_uri SetNameOfClassW(Int64 owlClass, byte[] name);
		...
		public static extern enum_error_code_set_uri SetNameOfClassEx(Int64 model, Int64 owlClass, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfClassEx")]
		public static extern enum_error_code_set_uri SetNameOfClassEx(Int64 model, Int64 owlClass, byte[] name);
		...
		public static extern enum_error_code_set_uri SetNameOfClassWEx(Int64 model, Int64 owlClass, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfClassWEx")]
		public static extern enum_error_code_set_uri SetNameOfClassWEx(Int64 model, Int64 owlClass, byte[] name);
		...
		/// <summary>
		///		GetClassPropertyByIterator                              (http://rdf.bg/gkdoc/CS64/GetClassPropertyByIterator.html)
		///
		...
		{
			long ignore;
			return GetClassPropertyByIterator(owlClass, rdfProperty, out ignore, out ignore);
		}

		/// <summary>
		///		GetClassPropertyByIteratorEx                            (http://rdf.bg/gkdoc/CS64/GetClassPropertyByIteratorEx.html)
		///
		///	Returns a handle to a property.
		///	If input property is zero, the handle will point to the first property having cardinality restriction to the class.
		///	else it will point to next propety with known restriction
		...
		{
			long ignore;
			return GetClassPropertyByIteratorEx(model, owlClass, rdfProperty, out ignore, out ignore);
		}
		...
		public static extern enum_error_code_set_uri SetNameOfProperty(Int64 rdfProperty, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfProperty")]
		public static extern enum_error_code_set_uri SetNameOfProperty(Int64 rdfProperty, byte[] name);
		...
		public static extern enum_error_code_set_uri SetNameOfPropertyW(Int64 rdfProperty, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfPropertyW")]
		public static extern enum_error_code_set_uri SetNameOfPropertyW(Int64 rdfProperty, byte[] name);
		...
		public static extern enum_error_code_set_uri SetNameOfPropertyEx(Int64 model, Int64 rdfProperty, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfPropertyEx")]
		public static extern enum_error_code_set_uri SetNameOfPropertyEx(Int64 model, Int64 rdfProperty, byte[] name);
		...
		public static extern enum_error_code_set_uri SetNameOfPropertyWEx(Int64 model, Int64 rdfProperty, string name);

		[DllImport(enginedll, EntryPoint = "SetNameOfPropertyWEx")]
		public static extern enum_error_code_set_uri SetNameOfPropertyWEx(Int64 model, Int64 rdfProperty, byte[] name);
